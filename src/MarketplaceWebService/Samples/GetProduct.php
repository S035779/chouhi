...
foreach($amazon_xml->GetMatchingProductForIdResult as $response){

    $getTitle = $response->Products->Product->AttributeSets->ns2_ItemAttributes->ns2_Title;

}

printf ("SUCCESS : MWS GetMatchingProduct completed! Title=%s\n", $getTitle );
