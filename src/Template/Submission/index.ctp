 ...
 * @var \App\Model\Entity\Submission[]|\Cake\Collection\CollectionInterface $submission
 */
?>
...
<div class="submission index large-9 medium-8 columns content">
    <h3><?= __('Submission') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('id') ?></th>
                <th scope="col"><?= $this->Paginator->sort('student_name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('affiliation') ?></th>
                <th scope="col"><?= $this->Paginator->sort('issue_name') ?></th>
        ...
        <tbody>
            <?php foreach ($submission as $submission): ?>
            <tr>
