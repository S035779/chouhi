            ...
            <div class="row">
              ...
              <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" novalidate>
                  ...
                  <div class="mb-3">
                    <label for="period">平均価格日数</label>
                    <input type="text"
                      class="form-control"
                      id="period"
                      placeholder="Input the target period" required>
                  ...
                  <div class="mb-3">
                    <label for="riserate">上昇率</label>
                    <input type="text"
                      class="form-control"
                      id="riserate"
                      placeholder="Input price rise rate" required>
                    <div class="invalid-feedback">
                  ...
                  <div class="mb-3">
                    <label for="proifit">利益幅</label>
                    <input type="text"
                      class="form-control"
                      id="profit"
                      placeholder="Input profit range" required>
                    <div class="invalid-feedback">
