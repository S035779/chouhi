...
class TeamMembersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'last_login_at' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'deleted' => '2018-05-05 19:35:59',
                'last_login_at' => '2018-05-05 19:35:59',
                'created' => '2018-05-05 19:35:59',
                'modified' => '2018-05-05 19:35:59'
            ],
        ];
        parent::init();
    }
